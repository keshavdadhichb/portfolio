...
const Preloader = () => {
    ...
    return (
        <div className="fixed inset-0 z-[6] flex pointer-events-none" ref={preloaderRef}>
            ...
            <p className="name-text flex text-[18vw] md:text-[15vw] lg:text-[220px] font-anton text-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 leading-none overflow-hidden text-[#f5f5f5] tracking-[0.25em]">
