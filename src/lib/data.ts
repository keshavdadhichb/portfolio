...
export const MY_STACK = {
    ...
    'AI & ML': [
        ...
        { name: 'Gen AI', icon: '/logo/genai.png' },
    ],
    'Blockchain': [
        { name: 'Solidity', icon: '/logo/solidity.png' },
        { name: 'Ethereum', icon: '/logo/ethereum.png' },
        { name: 'Web3.js', icon: '/logo/web3.png' },
        { name: 'Polygon', icon: '/logo/polygon.png' },
    ],
    'Cloud & DevOps': [
